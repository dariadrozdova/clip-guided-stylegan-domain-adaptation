...
## Доступ к полным результатам обучения

В репозиторий загружены только репрезентативные итоговые изображения для каждого эксперимента. Полная папка с результатами обучения (промежуточные sample-изображения, сравнения, дополнительные визуализации, чекпоинты, логированные лоссы и конфиги) размещена в Google Drive и доступна [по ссылке](https://drive.google.com/drive/folders/1t5SkUlUz4vvXPB7rNqZ1nAUQuTUmdN5e?usp=sharing).
